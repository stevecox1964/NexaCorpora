...
function SummaryMenuButton({ videoId, hasSummary, summaryState, onToggleSummary, onGenerateSummary }) {
  ...
  const handleSummarize = (type) => {
    setShowMenu(false);
    onGenerateSummary(videoId, type);
  };
    ...
    return (
      <>
        <button
          ...
          onClick={() => onToggleSummary(videoId)}
...
function TopicsPage() {
  ...
  const handleDeleteTranscript = async (videoId) => {
    ...
    try {
      ...
      updateVideoInClusters(videoId, { hasTranscript: false, hasSummary: false, transcriptProvider: null });
                      ...
                      <div className="topic-video-actions">
                        {video.hasTranscript ? (
                          <div className="transcript-actions-group">
                            ...
                            <button
                              className="btn btn-sm btn-icon"
                              onClick={() => handleDeleteTranscript(video.videoId)}
